...
>
  ...
  {/* Content */}
  <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-col lg:flex-row items-center justify-center lg:justify-between gap-12 lg:gap-16 w-full">
    {/* Text */}
    <motion.div
    ...
    >
      ...
      <p className="mt-6 text-base sm:text-lg md:text-lg lg:text-xl text-gray-300 max-w-2xl mx-auto lg:mx-0">
