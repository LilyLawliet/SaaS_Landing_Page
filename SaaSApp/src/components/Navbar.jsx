  ...
  return (
    <nav className="w-full fixed top-0 left-0 z-50 bg-white/10 backdrop-blur-xl border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
        ...
        <div className="text-lg sm:text-xl lg:text-2xl font-extrabold bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent tracking-tight cursor-pointer">
          Aurora AI
        </div>

        <div className="hidden lg:flex space-x-8 xl:space-x-10 text-gray-200 font-medium">
          {navItems.map((item) => (
            <a
              key={item}
        ...
        <div className="hidden lg:flex items-center space-x-3 xl:space-x-4">
          <button className="px-3 py-2 text-gray-300 hover:text-white transition">
            Sign In
          </button>
          <button className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-pink-500 text-white rounded-full font-semibold shadow-lg shadow-pink-500/30 hover:shadow-pink-500/50 transition">
            Get Started
          </button>
        </div>
